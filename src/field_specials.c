...
static const struct {
    ...
    [QL_LOCATION_RECRUIT_BASE]           = {MAP(MAP_RECRUIT_BASE_REGISTRATION_ROOM),        MAP(MAP_SECRET_WOODS)},
    [QL_LOCATION_OAKS_LAB]               = {MAP(MAP_PALLET_TOWN_PROFESSOR_OAKS_LAB),        MAP(MAP_PALLET_TOWN)},
    [QL_LOCATION_JOHTO_ENTRANCE]         = {MAP(MAP_ROUTE22_JOHTO_ENTRANCE),                MAP(MAP_ROUTE22)},
    [QL_LOCATION_ANCIENT_CAVE_ENTRANCE]  = {MAP(MAP_ANCIENT_CAVE_ENTRANCE),                 MAP(MAP_ROUTE22)},
    ...
    [QL_LOCATION_CINNABAR_VOLCANO]           = {MAP(MAP_CINNABAR_VOLCANO),                    MAP(MAP_RUINS_OF_CINNABAR)},
    [QL_LOCATION_CINNABAR_GYM]           = {MAP(MAP_CINNABAR_ISLAND_GYM),                   MAP(MAP_RUINS_OF_CINNABAR)},
    [QL_LOCATION_CINNABAR_LAB]           = {MAP(MAP_CINNABAR_ISLAND_POKEMON_LAB_ENTRANCE),  MAP(MAP_RUINS_OF_CINNABAR)},
...
void QuestLog_TryRecordDepartedLocation(void)
{
    ...
    if (FlagGet(FLAG_SYS_QL_DEPARTED))
    {
        ...
        else if (locationId == QL_LOCATION_JOHTO_ENTRANCE)
        {
...
const u16 sPokeCenter1FMaps[] = {
    ...
    MAP_PEWTER_CITY_PEWTER_BASE_HEALING_CENTER,
