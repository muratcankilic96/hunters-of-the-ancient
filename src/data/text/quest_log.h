...
const u8 gText_QuestLog_RecruitBase[] = _("RECRUIT BASE");
const u8 gText_QuestLog_OakResearchLab[] = _("OAK RESEARCH LAB");
const u8 gText_QuestLog_KantoJohtoBorder[] = _("KANTO-JOHTO BORDER");
const u8 gText_QuestLog_AncientCaveEntrance[] = _("ANCIENT CAVE ENTRANCE");
...
const u8 gText_QuestLog_CinnabarVolcano[] = _("CINNABAR VOLCANO");
