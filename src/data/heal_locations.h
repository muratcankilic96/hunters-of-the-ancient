static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_SECRET_WOODS - 1] = {MAP_GROUP(SECRET_WOODS), MAP_NUM(SECRET_WOODS), 14, 16},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_SECRET_WOODS - 1] = {MAP_GROUP(SECRET_WOODS), MAP_NUM(SECRET_WOODS)},
};
