...
static const struct HealLocation sHealLocations[NUM_HEAL_LOCATIONS - 1] = {
    [HEAL_LOCATION_RECRUIT_BASE - 1] = {
        .mapGroup = MAP_GROUP(MAP_SECRET_WOODS),
        .mapNum = MAP_NUM(MAP_SECRET_WOODS),
        .x = 14,
        .y = 16,
    },
    ...
    [HEAL_LOCATION_SECRET_ROCKS - 1] = {
        .mapGroup = MAP_GROUP(MAP_VOID),
        .mapNum = MAP_NUM(MAP_VOID),
        .x = 0,
        .y = 0,
    },
    ...
    [HEAL_LOCATION_GAME_OVER - 1] = {
        .mapGroup = MAP_GROUP(MAP_VOID),
        .mapNum = MAP_NUM(MAP_VOID),
        .x = 0,
        .y = 0,
    },
    [HEAL_LOCATION_RUINS_OF_CINNABAR - 1] = {
        .mapGroup = MAP_GROUP(MAP_RUINS_OF_CINNABAR),
        .mapNum = MAP_NUM(MAP_RUINS_OF_CINNABAR),
        .x = 14,
        .y = 12,
    },
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[NUM_HEAL_LOCATIONS - 1][2] = {
    [HEAL_LOCATION_RECRUIT_BASE - 1] = { MAP_GROUP(MAP_RECRUIT_BASE_ENTRANCE), MAP_NUM(MAP_RECRUIT_BASE_ENTRANCE)},
    [HEAL_LOCATION_VIRIDIAN_CITY - 1] = { MAP_GROUP(MAP_VIRIDIAN_CITY_VIRIDIAN_BASE_HEALING_CENTER), MAP_NUM(MAP_VIRIDIAN_CITY_VIRIDIAN_BASE_HEALING_CENTER)},
    [HEAL_LOCATION_PEWTER_CITY - 1] = { MAP_GROUP(MAP_PEWTER_CITY_PEWTER_BASE_HEALING_CENTER), MAP_NUM(MAP_PEWTER_CITY_PEWTER_BASE_HEALING_CENTER)},
    ...
    [HEAL_LOCATION_SECRET_ROCKS - 1] = { MAP_GROUP(MAP_VOID), MAP_NUM(MAP_VOID)},
    ...
    [HEAL_LOCATION_GAME_OVER - 1] = { MAP_GROUP(MAP_VOID), MAP_NUM(MAP_VOID)},
    [HEAL_LOCATION_RUINS_OF_CINNABAR - 1] = { MAP_GROUP(MAP_CINNABAR_ISLAND_POKEMON_CENTER_1F), MAP_NUM(MAP_CINNABAR_ISLAND_POKEMON_CENTER_1F)},
};

static const u8 sWhiteoutRespawnHealerNpcIds[NUM_HEAL_LOCATIONS - 1] = {
    [HEAL_LOCATION_RECRUIT_BASE - 1] = LOCALID_RECRUIT_BASE_NURSE,
    [HEAL_LOCATION_VIRIDIAN_CITY - 1] = LOCALID_VIRIDIAN_NURSE,
    [HEAL_LOCATION_PEWTER_CITY - 1] = LOCALID_PEWTER_ROCKET_NURSE,
    ...
    [HEAL_LOCATION_SECRET_ROCKS - 1] = 0,
    ...
    [HEAL_LOCATION_GAME_OVER - 1] = 0,
    [HEAL_LOCATION_RUINS_OF_CINNABAR - 1] = LOCALID_CINNABAR_NURSE,
};
