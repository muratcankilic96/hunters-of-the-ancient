...
{
    [SPAWN_RECRUIT_BASE - 1] = {MAP_GROUP(SECRET_WOODS), MAP_NUM(SECRET_WOODS), 14, 16},
    [SPAWN_VIRIDIAN_CITY - 1] = {MAP_GROUP(VIRIDIAN_CITY), MAP_NUM(VIRIDIAN_CITY), 56, 19},
    [SPAWN_PEWTER_CITY - 1] = {MAP_GROUP(PEWTER_CITY), MAP_NUM(PEWTER_CITY), 36, 51},
    ...
    [SPAWN_GAME_OVER - 1] = {MAP_GROUP(VOID), MAP_NUM(VOID), 0, 0},
};

static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    [SPAWN_RECRUIT_BASE - 1] = {MAP_GROUP(RECRUIT_BASE_ENTRANCE), MAP_NUM(RECRUIT_BASE_ENTRANCE)},
    [SPAWN_VIRIDIAN_CITY - 1] = {MAP_GROUP(VIRIDIAN_CITY_VIRIDIAN_BASE_HEALING_CENTER), MAP_NUM(VIRIDIAN_CITY_VIRIDIAN_BASE_HEALING_CENTER)},
    ...
    [SPAWN_GAME_OVER - 1] = {MAP_GROUP(VOID), MAP_NUM(VOID)},
};

static const u8 sWhiteoutRespawnHealerNpcIds[] =
{
    [SPAWN_RECRUIT_BASE - 1] = 1,
    [SPAWN_VIRIDIAN_CITY - 1] = 3,
