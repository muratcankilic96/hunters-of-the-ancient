...
const u8 gTrainerBackPic_PlayerM[] = INCBIN_U8("graphics/trainers/back_pics/player_m_back_pic.4bpp");
const u8 gTrainerBackPic_PlayerF[] = INCBIN_U8("graphics/trainers/back_pics/player_f_back_pic.4bpp");
...
const u32 gTrainerPalette_PlayerMBackPic[] = INCBIN_U32("graphics/trainers/palettes/player_m_back_pic.gbapal.lz");
const u32 gTrainerPalette_PlayerFBackPic[] = INCBIN_U32("graphics/trainers/palettes/player_f_back_pic.gbapal.lz");
