...
{
    [FACILITY_CLASS_SECURITY]               = TRAINER_PIC_SECURITY_GUARD,
    [FACILITY_CLASS_IPA]                    = TRAINER_PIC_IPA,
...
{
    [FACILITY_CLASS_SECURITY]               = TRAINER_CLASS_SECURITY,
    [FACILITY_CLASS_IPA]                    = TRAINER_CLASS_IPA,
    [FACILITY_CLASS_AQUA_GRUNT_F]           = TRAINER_CLASS_IPA,
