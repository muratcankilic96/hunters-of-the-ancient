...
const u16 gMetatiles_RocketHealingCenter[] = INCBIN_U16("data/tilesets/secondary/rocket_healing_center/metatiles.bin");
const u32 gMetatileAttributes_RocketHealingCenter[] = INCBIN_U32("data/tilesets/secondary/rocket_healing_center/metatile_attributes.bin");
