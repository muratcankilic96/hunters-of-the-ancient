...
static const u8 sAncientCaveMapPreviewPalette[] = INCBIN_U8("graphics/map_preview/victory_road/tiles.gbapal");
static const u8 sAncientCaveMapPreviewTiles[] = INCBIN_U8("graphics/map_preview/victory_road/tiles.4bpp.lz");
static const u8 sAncientCaveMapPreviewTilemap[] = INCBIN_U8("graphics/map_preview/victory_road/tilemap.bin.lz");
...
static const struct MapPreviewScreen sMapPreviewScreenData[MPS_COUNT] = {
    ...
    [MPS_ANCIENT_CAVE] = {
        .mapsec = MAPSEC_ANCIENT_CAVE,
        .type = MPS_TYPE_CAVE,
        .flagId = FLAG_WORLD_MAP_ANCIENT_CAVE,
        .tilesptr = sAncientCaveMapPreviewTiles,
        .tilemapptr = sAncientCaveMapPreviewTilemap,
        .palptr = sAncientCaveMapPreviewPalette
    },
    [MPS_CERULEAN_CAVE] = {
