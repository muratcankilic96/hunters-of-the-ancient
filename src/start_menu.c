...
static void PrintSaveStats(void)
{
    ...
    AddTextPrinterParameterized3(sSaveStatsWindowId, FONT_SMALL, 2, 28, sTextColor_StatName, -1, gSaveStatName_Artifacts);
    SaveStatToString(SAVE_STAT_ARTIFACTS, gStringVar4, 2);
    ...
    AddTextPrinterParameterized3(sSaveStatsWindowId, FONT_SMALL, 2, 42 + dexOffset, sTextColor_StatName, -1, gSaveStatName_Rank);
    SaveStatToString(SAVE_STAT_RANK, gStringVar4, 2);
    AddTextPrinterParameterized3(sSaveStatsWindowId, FONT_SMALL, 60, 42 + dexOffset, sTextColor_StatValue, -1, gStringVar4);
    AddTextPrinterParameterized3(sSaveStatsWindowId, FONT_SMALL, 2, 56 + dexOffset, sTextColor_StatName, -1, gSaveStatName_Time);
    SaveStatToString(SAVE_STAT_TIME, gStringVar4, 2);
    AddTextPrinterParameterized3(sSaveStatsWindowId, FONT_SMALL, 60, 56 + dexOffset, sTextColor_StatValue, -1, gStringVar4);
