...
static const u8 *const sLocationNameTexts[] =
{
    ...
    [QL_LOCATION_JOHTO_ENTRANCE]             = gText_QuestLog_KantoJohtoBorder,
    [QL_LOCATION_ANCIENT_CAVE_ENTRANCE]      = gText_QuestLog_AncientCaveEntrance,
    ...
    [QL_LOCATION_PEWTER_GYM]                 = gText_QuestLog_DepartedGym, // TODO: Add first artifact-related text and fix other gym text
    [QL_LOCATION_MT_MOON_1]                  = gText_QuestLog_MtMoon,
    [QL_LOCATION_MT_MOON_2]                  = gText_QuestLog_MtMoon,
    [QL_LOCATION_CERULEAN_GYM]               = gText_QuestLog_DepartedGym,
    ...
    [QL_LOCATION_VERMILION_GYM]              = gText_QuestLog_DepartedGym,
    ...
    [QL_LOCATION_CELADON_GYM]                = gText_QuestLog_DepartedGym,
    ...
    [QL_LOCATION_CINNABAR_VOLCANO]           = gText_QuestLog_CinnabarVolcano,
    [QL_LOCATION_CINNABAR_GYM]               = gText_QuestLog_DepartedGym,
...
static const u8 sLocationToDepartedTextId[] =
{
    ...
    [QL_LOCATION_JOHTO_ENTRANCE]             = QL_DEPARTED_MISC_BUILDING_1,
    [QL_LOCATION_ANCIENT_CAVE_ENTRANCE]      = QL_DEPARTED_MISC_BUILDING_1,
    ...
    [QL_LOCATION_CINNABAR_VOLCANO]               = QL_DEPARTED_MISC_BUILDING_2,
