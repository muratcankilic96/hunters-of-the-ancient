...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    [OBJ_EVENT_GFX_PLAYER_M_NORMAL / 2]         = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_RED_BIKE
    ...
    [OBJ_EVENT_GFX_RED_VS_SEEKER_BIKE / 2]      = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_PLAYER_F_NORMAL
    ...
    [OBJ_EVENT_GFX_BLACK / 2]                   = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_BILL
    ...
    [OBJ_EVENT_GFX_ROCKET_NURSE / 2]            = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_RESERVED
};
