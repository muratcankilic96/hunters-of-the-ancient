...
#define IN_PLAYERS_HOUSE \
    ((gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_RECRUIT_BASE_ENTRANCE) \
  && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_RECRUIT_BASE_ENTRANCE))     \
 || (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_RECRUIT_BASE_REGISTRATION_ROOM)  \
  && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_RECRUIT_BASE_REGISTRATION_ROOM)))    \
