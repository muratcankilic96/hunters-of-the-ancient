...
const u8 gText_ArtifactsUnused[] = _("もっているバッジ");
...
const u8 gText_Man[] = _("MAN");
const u8 gText_Woman[] = _("WOMAN");
...
const u8 gSaveStatName_Artifacts[] = _("ARTIFACTS");
const u8 gSaveStatName_Rank[] = _("RANK");
...
const u8 gText_UseOfItemHereIsForbidden[] = _("It is not a good time or place to\nuse this. The BOSS would complain.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CantUseUntilNewArtifact[] = _("This can't be used until a new\nARTIFACT is obtained.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Boulderartifact[] = _("BOULDERARTIFACT");
const u8 gText_Cascadeartifact[] = _("CASCADEARTIFACT");
const u8 gText_Thunderartifact[] = _("THUNDERARTIFACT");
const u8 gText_Rainbowartifact[] = _("RAINBOWARTIFACT");
const u8 gText_Soulartifact[] = _("SOULARTIFACT");
const u8 gText_Marshartifact[] = _("MARSHARTIFACT");
const u8 gText_Volcanoartifact[] = _("VOLCANOARTIFACT");
const u8 gText_Earthartifact[] = _("EARTHARTIFACT");
...
const u8 gText_BossPc[] = _("BOSS's PC");
...
const u8 gText_TransferThisPokemon[] = _("Transfer this POKéMON?");
const u8 gText_PkmnWasTransferred[] = _("{DYNAMIC 0x00} was sent to HQ.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0x00}!");
const u8 gText_GainedExpCandy[] = _("You get {DYNAMIC 0x00}.");
const u8 gText_GainedExpCandyRequest1[] = _("BOSS thanks you and");
const u8 gText_GainedExpCandyRequest2[] = _("sends 2 of {DYNAMIC 0x00}.");
...
const u8 gText_YouCantTransferAnEgg[] = _("You can't transfer an EGG.");
const u8 gText_ContinueBoxOperations[] = _("Continue BOX operations?");
const u8 gText_PkmnCameBack[] = _("{DYNAMIC 0x00} came back!");
const u8 gText_BossRejectedTransfer[] = _("BOSS rejected {DYNAMIC 0x00}.");
...
const u8 gText_BagIsFull3[] = _("Bag is full. Sent to PC.");
...
const u8 gPCText_Transfer[] = _("TRANSFER");
...
const u8 gText_RegionMap_AreaDesc_RecruitBase[] = _("A secret place in the woods where\nno law and order could extend\ntheir hands due to its privacy.\nCriminals take their first step\nthere.");
...
const u8 gText_RegionMap_AreaDesc_AncientCave[] = _("A cavern situated on ROUTE 22.\nIt is rumored to have\ndeep connections with the eight\nmysterious artifacts that are\npreserved by officials.");
const u8 gText_RegionMap_AreaDesc_CinnabarVolcano[] = _("A decrepit, burned-down mansion\non CINNABAR ISLAND.\nIt got its name because a famous\nPOKéMON researcher lived there.");
...
const u8 gText_PokeSum_Stolen[] = _("{DYNAMIC 0x00} nature.\nStolen from {DYNAMIC 0x03} in\n{DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.");
...
const u8 gText_PlayerScurriedToHideout[] = _("{PLAYER} was quickly dragged away by\nTEAM ROCKET associates, protecting\n{PLAYER} with the exhausted and\nfainted POKéMON from the police‥\p");
const u8 gText_PlayerScurriedBackRecruitBase[] = _("{PLAYER} somehow managed to return to the\nRECRUIT BASE and has been healed by\nthe hideout nurse there‥\p");
const u8 gText_PlayerHasBeenArrested[] = _("Unfortunately, {PLAYER} has been arrested\nand seemingly, yet another group of\nTEAM ROCKET recruits has paid for their\ncrimes in reckless and petulant ways.\nIt's over.\p");
...
const u8 gText_Artifacts[] = _("ARTIFACTS");
const u8 gText_Rank[] = _("RANK");
