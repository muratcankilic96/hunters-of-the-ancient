...
static const u8 sNightLamp_Gfx[] = INCBIN_U8("graphics/battle_anims/unused/water.4bpp");
static const u8 sNightLamp[] = INCBIN_U8("graphics/battle_anims/unused/water.bin");
