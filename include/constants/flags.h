...
#define FLAG_GOT_POKEBALLS_ON_SECRET_PATH                0x231
...
#define FLAG_HIDDEN_ITEM_SSANNE_EXTERIOR_LAVA_COOKIE                       (FLAG_HIDDEN_ITEMS_START + 189)
...
#define FLAG_ARTIFACT01_GET                                         (SYS_FLAGS + 0x20)
#define FLAG_ARTIFACT02_GET                                         (SYS_FLAGS + 0x21)
#define FLAG_ARTIFACT03_GET                                         (SYS_FLAGS + 0x22)
#define FLAG_ARTIFACT04_GET                                         (SYS_FLAGS + 0x23)
#define FLAG_ARTIFACT05_GET                                         (SYS_FLAGS + 0x24)
#define FLAG_ARTIFACT06_GET                                         (SYS_FLAGS + 0x25)
#define FLAG_ARTIFACT07_GET                                         (SYS_FLAGS + 0x26)
#define FLAG_ARTIFACT08_GET                                         (SYS_FLAGS + 0x27)
#define NUM_ARTIFACTS                                               (1 + FLAG_ARTIFACT08_GET - FLAG_ARTIFACT01_GET)

#define FLAG_SYS_POKEMON_GET                                        (SYS_FLAGS + 0x28)
#define FLAG_SYS_POKEDEX_GET                                        (SYS_FLAGS + 0x29)
#define FLAG_SYS_CLOCK_SET                                          (SYS_FLAGS + 0x2A)
...
#define FLAG_WORLD_MAP_ANCIENT_CAVE                                 (SYS_FLAGS + 0xB5)
...
#define FLAG_WORLD_MAP_ROTSMELL_CAVE                                (SYS_FLAGS + 0xC2)
