...
extern const u8 gNameChoice_Black[];
extern const u8 gNameChoice_Kirk[];
extern const u8 gNameChoice_Syd[];
extern const u8 gNameChoice_Adam[];

extern const u8 gNameChoice_Axl[];
extern const u8 gNameChoice_Cash[];
extern const u8 gNameChoice_Chad[];
extern const u8 gNameChoice_Damon[];
extern const u8 gNameChoice_David[];
extern const u8 gNameChoice_Doug[];
extern const u8 gNameChoice_Eric[];
extern const u8 gNameChoice_Frank[];
extern const u8 gNameChoice_Harry[];
extern const u8 gNameChoice_Ike[];
extern const u8 gNameChoice_Jerry[];
extern const u8 gNameChoice_John[];
extern const u8 gNameChoice_Mick[];
extern const u8 gNameChoice_Nick[];
extern const u8 gNameChoice_Rick[];
extern const u8 gNameChoice_Roger[];
extern const u8 gNameChoice_Storm[];
extern const u8 gNameChoice_Vince[];
extern const u8 gNameChoice_Will[];

extern const u8 gNameChoice_Anni[];
extern const u8 gNameChoice_Delia[];
extern const u8 gNameChoice_Emma[];
extern const u8 gNameChoice_Faith[];
extern const u8 gNameChoice_Felicia[];
extern const u8 gNameChoice_Holly[];
extern const u8 gNameChoice_Jenny[];
extern const u8 gNameChoice_Kate[];
extern const u8 gNameChoice_Lana[];
extern const u8 gNameChoice_Marge[];
extern const u8 gNameChoice_Morgan[];
extern const u8 gNameChoice_Nora[];
extern const u8 gNameChoice_Pat[];
extern const u8 gNameChoice_Rei[];
extern const u8 gNameChoice_Ruth[];
extern const u8 gNameChoice_Sara[];
extern const u8 gNameChoice_Selma[];
extern const u8 gNameChoice_Suvi[];
extern const u8 gNameChoice_Tara[];

extern const u8 gGiovanniSpeech_Text_AskPlayerGender[];
extern const u8 gKoffingIntro_Text_Page1[];
extern const u8 gKoffingIntro_Text_Page2[];
extern const u8 gKoffingIntro_Text_Page3[];
extern const u8 gGiovanniSpeech_Text_WelcomeToTheTeam[];
extern const u8 gGiovanniSpeech_Text_OurTeams[];
extern const u8 gGiovanniSpeech_Text_CapturingAllOfThese[];
extern const u8 gGiovanniSpeech_Text_WeCapturePokemon[];
extern const u8 gGiovanniSpeech_Text_IWouldLikeToKnowAboutYou[];
extern const u8 gGiovanniSpeech_Text_WhatWasYourName[];
extern const u8 gGiovanniSpeech_Text_SoYouArePlayer[];
extern const u8 gGiovanniSpeech_Text_ThisIsAnotherRecruit[];
extern const u8 gGiovanniSpeech_Text_WhatIsYourColleagueName[];
extern const u8 gGiovanniSpeech_Text_ConfirmRivalName[];
extern const u8 gGiovanniSpeech_Text_HisNameIsRival[];
extern const u8 gGiovanniSpeech_Text_MakeTeamRocketProud[];
...
extern const u8 Help_Text_Artifacts[];
...
extern const u8 Help_Text_Artifacts2[];
...
extern const u8 Help_Text_DefineArtifacts[];
...
extern const u8 Help_Text_DefineArtifacts2[];
