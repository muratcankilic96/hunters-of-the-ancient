...
#define DAMAGE_CATEGORY_ICON_PHYSICAL    (NUMBER_OF_MON_TYPES + 6)
#define DAMAGE_CATEGORY_ICON_SPECIAL     (NUMBER_OF_MON_TYPES + 7)
#define DAMAGE_CATEGORY_ICON_STATUS      (NUMBER_OF_MON_TYPES + 8)
