...
extern const u8 gText_UseOfItemHereIsForbidden[];
...
extern const u8 gText_UsedExpCandy[];
...
extern const u8 gText_CantUseUntilNewArtifact[];
...
extern const u8 gSaveStatName_Rank[];
...
extern const u8 gText_BoulderArtifact[];
extern const u8 gText_CascadeArtifact[];
extern const u8 gText_ThunderArtifact[];
extern const u8 gText_RainbowArtifact[];
extern const u8 gText_SoulArtifact[];
extern const u8 gText_MarshArtifact[];
extern const u8 gText_VolcanoArtifact[];
extern const u8 gText_EarthArtifact[];
...
extern const u8 gText_RegionMap_AreaDesc_RecruitBase[];
...
extern const u8 gText_RegionMap_AreaDesc_AncientCave[];
...
// field_screen_effect
extern const u8 gText_PlayerScurriedToHideout[];
extern const u8 gText_PlayerScurriedBackRecruitBase[];
extern const u8 gText_PlayerHasBeenArrested[];
...
extern const u8 gText_QuestLog_CompletedRegistrations[];
...
extern const u8 gText_QuestLog_RecruitBase[];
extern const u8 gText_QuestLog_OakResearchLab[];
extern const u8 gText_QuestLog_KantoJohtoBorder[];
extern const u8 gText_QuestLog_AncientCaveEntrance[];
...
extern const u8 gText_QuestLog_CinnabarVolcano[];
...
extern const u8 gText_TransferThisPokemon[];
extern const u8 gText_PkmnWasTransferred[];
extern const u8 gText_ByeByePkmn[];
extern const u8 gText_GainedExpCandy[];
extern const u8 gText_GainedExpCandyRequest1[];
extern const u8 gText_GainedExpCandyRequest2[];
extern const u8 gText_MarkYourPkmn[];
extern const u8 gText_ThatsYourLastPkmn[];
extern const u8 gText_YourPartysFull[];
extern const u8 gText_YoureHoldingAPkmn[];
extern const u8 gText_WhichOneWillYouTake[];
extern const u8 gText_YouCantTransferAnEgg[];
extern const u8 gText_ContinueBoxOperations[];
extern const u8 gText_PkmnCameBack[];
extern const u8 gText_BossRejectedTransfer[];
...
extern const u8 gText_BagIsFull3[];
...
extern const u8 gPCText_Transfer[];
...
extern const u8 gText_PokeSum_Stolen[];
